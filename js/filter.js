...
const finByHt = document.querySelectorAll(".search-btnht button");
const priceHT = document.querySelectorAll(".list-post .post-card");

const findHt = (e) => {
  document.querySelector(".active-ht").classList.remove("active-ht");
  e.target.classList.add("active-ht");

  priceHT.forEach((card) => {
    card.classList.add("hide-price");

    if (
      card.dataset.ht === e.target.dataset.ht ||
      e.target.dataset.ht === "all"
    ) {
      card.classList.remove("hide-price");
    }
  });
...
finByHt.forEach((button) => button.addEventListener("click", findHt));





// //Filter btn search tour by days

// const findByDay = document.querySelectorAll(".search-btnDay button");
// const dayTour = document.querySelectorAll(".list-post .post-card");

// const findDay = (e) => {
//   document.querySelector(".active-day").classList.remove("active-day");
//   e.target.classList.add("active-day");

//   dayTour.forEach((card) => {
//     card.classList.add("hide-price");

//     if (
//       card.dataset.day === e.target.dataset.day ||
//       e.target.dataset.day === "all"
//     ) {
//       card.classList.remove("hide-price");
//     }
//   });
...
// findByDay.forEach((button) => button.addEventListener("click", findDay));
...
const btnCalendar = document.getElementById("filter-calendar");
const boxCalendar = document.getElementById("wrap-calendar");

btnCalendar.addEventListener("click", () => {
  btnCalendar.classList.toggle("active");
